...
plt.legend()
plt.tight_layout()
plt.savefig("output-figs/fair_temperature_impact_projects.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.xlabel("Year")
plt.ylabel("ΔT relative to baseline (K)")
plt.title("CH4: actual vs implied temperature impact")
plt.legend()
plt.tight_layout()
plt.savefig("output-figs/fair_temperature_impact_ch4.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.xlabel("Year")
plt.ylabel("ΔT relative to baseline (K)")
plt.title("CFC-12: actual vs implied temperature impact")
plt.legend()
plt.tight_layout()
plt.savefig("output-figs/fair_temperature_impact_cfc12.png", dpi=300, bbox_inches="tight")
plt.show()
